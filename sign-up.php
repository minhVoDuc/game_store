			...
			<div class="limiter">
				<div class="container-login100" style="background-image: url('images/bg-06.jpg');">
					<div class="wrap-login100 p-t-30 p-b-50">
						...
						<form id="signUp-form" class="login100-form validate-form p-b-33 p-t-5" method="post">
							...
							<div class="container-login100-form-btn m-t-32">
								<button id="btn-signUp" class="login100-form-btn">
									Register
								</button>
							</div>

							<div class="container-login100-form-btn m-t-10">
								<a class="SIU-nav" href="sign-in.html">Already have an account? <span>Sign in here</span></a>
							</div>
