...
<body class="hold-transition sidebar-mini layout-fixed">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-3 col-6">
                            <!-- small box -->
                            <div class="small-box bg-danger panel-prod">
                                <div class="inner">
                                    <h3>number of prod list</h3>
                                ...
                                <a href="admin-products.php" class="small-box-footer">Details   <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <!-- ./col -->
                        <div class="col-lg-3 col-6">
                            <!-- small box -->
                            <div class="small-box bg-primary panel-user">
                                <div class="inner">
                                ...
                                <a href="admin-users.php" class="small-box-footer">Details   <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <!-- ./col -->
                        <div class="col-lg-3 col-6">
                            <!-- small box -->
                            <div class="small-box bg-success panel-admin">
                                <div class="inner">
                                ...
                                <a href="admin-members.php" class="small-box-footer">Details   <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- for script -->
        ...
        <script type="text/javascript"> 
            ...
            var admin_home = true, admin_prod = false, admin_user = false, admin_admin = false;
        </script>
