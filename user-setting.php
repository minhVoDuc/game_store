...
<body style="background-color: rgb(7, 30, 61);">
			...
			<div class="container">
				<div class="page">			
					<div class="entry-content">
                        <div class="row" style="background-color: #1f4287; padding: 20px;">
                            <div id="user-logo" class="col-sm-6 col-md-4">
                                <div class="product-images">
                                    <figure class="large-image">
                                        <a href="dummy/Logo.png"><img src="dummy/Logo.png" alt=""></a>
                                    </figure>
                                </div>
                            </div>
                            <div id="user-info" class="col-sm-6 col-md-8">
                                <h2 style="color: #fff">Username: <strong id="setting-userName"></strong></h2>
                                <h2 style="margin-bottom: 5px">Log purchase:</h2>
                                <table class="user-log">
                                    <thead>
                                        <tr>
                                            <th width=5% class="log-id">Index</th>
                                            <th width=95% class="log-time">Time log</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <td class="log-id">1</td>
                                            <td class="each-time">thurdsafas</td>
                                        </tr>
                                    </tbody>
                                </table> <!-- .cart -->
                                
                                <h2 style="margin-bottom: 5px; display: inline-block">Change information:</h2>
                                <a href="#" class="button changeName">Username</a>
                                <a href="#" class="button changePass">Password</a>
                            </div>
                        </div>
					</div>
					...
					<section id="sec_fullLib">
                        ...
                        <div class="product-list">
                            <div id="empty_lib" class="hidden"><h3 class="noti">EMPTY</h3></div>
	...
	<script type="text/javascript"> 
		...
		var site_home = false, site_prod = false, site_cart = false, site_user = true;
        var userName = "<?php echo isset($_SESSION['User_name']) ? $_SESSION['User_name'] : null; ?>";
        var set_newPass;
	</script>
