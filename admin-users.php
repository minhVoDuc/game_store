...
<head>
    ...
    <title>HCMG Admin | User List</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="content-wrapper" style="min-height: 365px; background-color: rgb(227, 227, 242);">
            ...
            <section>
                <div class="container">
                    <a href="#" class="btn btn-primary m-b-1em btn-addUser" style="margin-bottom: 10px">New User</a>
    ...
    <!-- for script -->
        ...
        <script type="text/javascript"> 
            ...
            var admin_home = false, admin_prod = false, admin_user = true, admin_admin = false;
        </script>
