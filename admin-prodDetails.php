...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="content-wrapper" style="min-height: 365px; background-color: rgb(227, 227, 242);">
            ...
            <section class="content">
                <div class="section">
                    ...
                    <div class="center"><?php echo "<a href='index.php?page=". $page . "'class='btn btn-danger'>Back</a>"; ?></div>
                </div>

                <div class="aside">
                    <h3 style="text-align: center;">User Purchased</h3>
    ...
    <!-- for script -->
        ...
        <script type="text/javascript"> 
            ...
            var curPage = "<?php echo isset($_GET['Page']) ? $_GET['Page'] : null; ?>";
        </script>
        <script src="js/admin-singleProd.js"></script>
    <!-- for script -->
</body>
</html>